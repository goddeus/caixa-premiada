      ...
      if (response.data.wonPrize) {
        ...
        const mappedPrize = {
          ...
          if (!apiPrize.sem_imagem) {
            ...
            } else if (apiPrize.nome.includes('BONÉ')) {
              ...
              <div className="flex justify-center gap-3 mb-2">
                {user?.saldo >= 2.50 ? (
                  <button
                    ...
                    disabled={isSimulating || (user?.saldo || 0) < 2.50}
                    style={{background: 'rgb(14, 16, 21)', border: 'none', padding: '0px', borderRadius: '1.5rem', minWidth: '240px', cursor: (isSimulating || (user?.saldo || 0) < 2.50) ? 'not-allowed' : 'pointer', opacity: (isSimulating || (user?.saldo || 0) < 2.50) ? 0.5 : 1, display: 'flex', alignItems: 'center', justifyContent: 'flex-start', boxShadow: 'none'}}
                  >
