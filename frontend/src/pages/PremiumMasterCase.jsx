              ...
              <div className="flex justify-center gap-3 mb-2">
                {user?.saldo >= 15.00 ? (
                  <button
                    ...
                    disabled={isSimulating || (user?.saldo || 0) < 15.00}
                    style={{background: 'rgb(14, 16, 21)', border: 'none', padding: '0px', borderRadius: '1.5rem', minWidth: '240px', cursor: (isSimulating || (user?.saldo || 0) < 15.00) ? 'not-allowed' : 'pointer', opacity: (isSimulating || (user?.saldo || 0) < 15.00) ? 0.5 : 1, display: 'flex', alignItems: 'center', justifyContent: 'flex-start', boxShadow: 'none'}}
                  >
