...
const SamsungCase = () => {
  ...
  const handleOpenCase = async () => {
    ...
    const result = await executeWithLock(async () => {
      ...
      const samsungCase = casesResponse.cases?.find(c => 
        c.nome === 'CAIXA SAMSUNG' || c.nome.includes('SAMSUNG')
      );
      console.log('🎯 Caixa Samsung encontrada:', samsungCase);
      ...
      for (let i = 0; i < quantity; i++) {
        try {
          ...
          while (retryCount < maxRetries) {
            try {
              response = await api.post(`/cases/buy/${samsungCase.id}`);
        ...
        {!showIncentive && (
          <>
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300 mb-4 text-lg">Ganhe até Samsung S25!</p>
