...
const SamsungCase = () => {
  ...
  const handleSimulateCase = () => {
    ...
    const incentivePrizes = [
      { name: 'S25 ULTRA', value: 'R$ 5.000,00', rarity: 'rarity-5.png', image: '/imagens/CAIXA SAMSUNG/s25.png', bgColor: 'rgb(255, 215, 0)' },
      { name: 'NOTEBOOK', value: 'R$ 3.000,00', rarity: 'rarity-4.png', image: '/imagens/CAIXA SAMSUNG/notebook samsung.png', bgColor: 'rgb(255, 59, 59)' },
      { name: 'FONE SAMSUNG', value: 'R$ 1.000,00', rarity: 'rarity-4.png', image: '/imagens/CAIXA SAMSUNG/fone samsung.png', bgColor: 'rgb(255, 59, 59)' },
      ...
      try {
        ...
        if (response.data.wonPrize) {
          ...
          if (!apiPrize.sem_imagem) {
            if (apiPrize.nome.includes('GALAXY S24') || apiPrize.nome.includes('S24') || apiPrize.nome.includes('S25')) {
              mappedPrize.rarity = 'rarity-5.png';
              mappedPrize.image = '/imagens/CAIXA SAMSUNG/s25.png';
              mappedPrize.bgColor = 'rgb(255, 215, 0)';
            } else if (apiPrize.nome.includes('NOTEBOOK') || apiPrize.nome.includes('LAPTOP')) {
            ...
            } else if (apiPrize.nome.includes('FONE') || apiPrize.nome.includes('AUDIFONE')) {
  ...
  const generateRandomPrizeSequence = () => {
    ...
    const illustrativePrizes = [
      { name: 'FONE SAMSUNG', value: 'R$ 1.000,00', rarity: 'rarity-5.png', image: '/imagens/CAIXA SAMSUNG/fone samsung.png', bgColor: 'rgb(255, 215, 0)', sorteavel: false },
      { name: 'NOTEBOOK SAMSUNG', value: 'R$ 3.000,00', rarity: 'rarity-5.png', image: '/imagens/CAIXA SAMSUNG/notebook samsung.png', bgColor: 'rgb(255, 215, 0)', sorteavel: false },
      { name: 'SAMSUNG S25', value: 'R$ 5.000,00', rarity: 'rarity-5.png', image: '/imagens/CAIXA SAMSUNG/samsung s25.png', bgColor: 'rgb(255, 215, 0)', sorteavel: false }
    ];
  ...
  const playAgain = () => {
    ...
    // A página já está na caixa Samsung, então não precisa navegar
  };
  ...
  const nextPrize = () => {
    if (currentPrizeIndex < wonPrizes.length - 1) {
      ...
      setTimeout(() => {
        creditPrize(wonPrizes[newIndex], currentSamsungCase);
      }, 500);
    }
  };
    ...
    <>
        ...
        {!showIncentive && (
          <>
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl font-extrabold text-white mb-2 drop-shadow-lg">CAIXA SAMSUNG</h1>
      ...
      {showSimulation && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-[#0E1015] rounded-lg p-6 w-full max-w-4xl mx-4">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-white mb-2">Abrindo Caixa Samsung</h2>
      ...
      {showResult && selectedPrize && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-gradient-to-t from-purple-500 from-[-60%] via-[5%] to-100% via-slate-900 to-slate-900 animate-in fade-in-0 zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border p-6 shadow-lg duration-200 outline-none overflow-auto not-sm:p-4 px-10 py-11 sm:max-w-[510px] max-h-[92dvh]">
            <div className="flex flex-col gap-2 text-center sm:text-left">
              <div className="-m-10 mb-0 select-none relative">
                <img src="/imagens/deposito.jpg" className="w-full sm:rounded-t-lg" alt="Depósito" />
                <div className="absolute bg-gradient-to-b from-black/10 via-black/10 from-0% via-85% to-100% to-slate-900 size-full z-10 top-0"></div>
              </div>
            </div>
            
            <div className="flex items-center gap-2">
              <svg fill="none" viewBox="0 0 24 24" width="1em" height="1em" xmlns="http://www.w3.org/2000/svg" className="size-7 text-white">
            ...
            <form className="space-y-3 overflow-hidden">
              <div>
              ...
              <div className="overflow-hidden">
                <div className="flex gap-2 mb-2 pt-3 pb-1 pl-[2px] select-none">
                  <div 
                    className={`bg-purple-500/10 text-purple-500 text-base font-semibold w-fit rounded-md p-3 py-2 cursor-pointer relative hover:bg-purple-500/20 ${depositAmount === '20,00' ? 'ring-2 ring-yellow-400' : ''}`}
                    onClick={() => setDepositAmount('20,00')}
                  >
                    R$&nbsp;20,00
                  </div>
                  <div 
                    className={`bg-purple-500/10 text-purple-500 text-base font-semibold w-fit rounded-md p-3 py-2 cursor-pointer relative hover:bg-purple-500/20 ring-2 ring-yellow-400 ${depositAmount === '30,00' ? 'ring-2 ring-yellow-400' : ''}`}
                    onClick={() => setDepositAmount('30,00')}
                  >
                    <span className="bg-yellow-400 rounded-md absolute -top-0.5 left-2/4 -translate-y-2/4 -translate-x-2/4 text-xs text-black leading-4 px-1 uppercase flex gap-1 items-center text-nowrap">
                      <svg width="1em" height="1em" fill="currentColor" className="bi bi-fire size-[0.64rem] inline" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div 
                    className={`bg-purple-500/10 text-purple-500 text-base font-semibold w-fit rounded-md p-3 py-2 cursor-pointer relative hover:bg-purple-500/20 ${depositAmount === '50,00' ? 'ring-2 ring-yellow-400' : ''}`}
                    onClick={() => setDepositAmount('50,00')}
                  >
                    R$&nbsp;50,00
                  </div>
                  <div 
                    className={`bg-purple-500/10 text-purple-500 text-base font-semibold w-fit rounded-md p-3 py-2 cursor-pointer relative hover:bg-purple-500/20 ${depositAmount === '100,00' ? 'ring-2 ring-yellow-400' : ''}`}
                    onClick={() => setDepositAmount('100,00')}
                  >
                    R$&nbsp;100,00
                  </div>
                  <div 
                    className={`bg-purple-500/10 text-purple-500 text-base font-semibold w-fit rounded-md p-3 py-2 cursor-pointer relative hover:bg-purple-500/20 ${depositAmount === '200,00' ? 'ring-2 ring-yellow-400' : ''}`}
                    onClick={() => setDepositAmount('200,00')}
                  >
                    R$&nbsp;200,00
                  </div>
                  <div 
                    className={`bg-purple-500/10 text-purple-500 text-base font-semibold w-fit rounded-md p-3 py-2 cursor-pointer relative hover:bg-purple-500/20 ${depositAmount === '500,00' ? 'ring-2 ring-yellow-400' : ''}`}
              ...
              <button 
                className="active:scale-95 transition-all inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive bg-purple-500 text-white shadow-xs hover:bg-purple-500/90 h-10 rounded-md px-6 has-[>svg]:px-4 w-full mx-auto mt-4 relative overflow-hidden !transition-all !duration-700 ease-out !py-6 cursor-pointer [clip-path:circle(100%)]" 
                type="submit"
              >
                <svg width="1em" height="1em" fill="currentColor" viewBox="0 0 24 24" pathFill="currentColor" xmlns="http://www.w3.org/2000/svg" className="size-5">
            ...
            <button 
              type="button" 
              className="!size-6 cursor-pointer z-10 active:scale-85 ring-offset-background focus-visible:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-4 right-4 rounded-xs opacity-70 transition-all hover:opacity-100 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0"
              onClick={() => setShowDepositModal(false)}
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-x-icon lucide-x text-white">
