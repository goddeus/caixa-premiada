          ...
          <div className="flex items-center gap-2">
            {!isAuthenticated ? (
              ...
              <div className="flex items-center space-x-4">
                <div className={`flex items-center space-x-2 px-3 py-1 rounded-lg ${isDemoAccount() ? 'bg-yellow-600' : 'bg-green-600'}`}>
                  ...
                  <span className="text-white font-semibold">
                    ...
                    {isDemoAccount() && <span className="text-xs ml-1 opacity-75">(DEMO)</span>}
                  </span>
                </div>
                ...
                <button 
                  onClick={() => {
                    if (isDemoAccount()) {
                      toast.error('Saque indisponível nesta conta (modo demonstração).');
                      return;
                    }
          ...
          <div className="flex items-center gap-2">
            {!isAuthenticated ? (
              ...
              <div className="flex items-center space-x-2">
                <div className={`flex items-center space-x-2 px-2 py-1 rounded-lg ${isDemoAccount() ? 'bg-yellow-600' : 'bg-green-600'}`}>
