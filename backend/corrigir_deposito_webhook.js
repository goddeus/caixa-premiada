...
async function main() {
  try {
    ...
    // 7. Informações sobre o problema do webhook
    console.log('\n🔧 INFORMAÇÕES SOBRE O PROBLEMA:');
    console.log('   ❌ Webhook falhando: "The column Transaction.related_id does not exist"');
    console.log('   💡 CAUSA: Incompatibilidade entre schema Prisma e banco de dados');
    console.log('   🛠️  SOLUÇÃO: Executar migração do banco de dados');
    console.log('   📝 COMANDO: npx prisma db push');
