// TESTE DO ERRO DO USUÁRIO AUTENTICADO
const axios = require('axios');

const API_BASE_URL = 'https://slotbox-api.onrender.com/api';

async function testAuthenticatedUserError() {
  console.log('🧪 TESTE DO ERRO DO USUÁRIO AUTENTICADO');
  console.log('========================================');
