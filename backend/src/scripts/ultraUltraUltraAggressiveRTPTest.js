...
async function ultraUltraUltraAggressiveRTPTest() {
  console.log('💀 TESTE COM RTP ULTRA ULTRA ULTRA AGRESSIVO (0.1%)');
  console.log('===================================================\n');
  console.log('🎯 Objetivo: FORÇAR quebra total dos usuários');
  console.log('💰 RTP alvo: 0.1% (extremamente agressivo)\n');

  try {
    // Ajustar RTP para 0.1% (ultra ultra ultra agressivo)
    console.log('⚙️ Ajustando RTP para 0.1%...');
    await prisma.rTPConfig.updateMany({
      data: {
        rtp_target: 0.1
      }
    });
    console.log('✅ RTP ajustado para 0.1%\n');
    ...
    for (let i = 1; i <= 3; i++) {
      const user = await prisma.user.create({
        data: {
          email: `teste.ultra.ultra.ultra.${timestamp}.${i}@teste.com`,
          nome: `Usuário Ultra Ultra Ultra ${i}`,
          saldo: 20.00,
          senha_hash: 'teste123',
    ...
    console.log('🎲 INICIANDO TESTE ULTRA ULTRA ULTRA AGRESSIVO...\n');
    ...
    // Relatório final
    console.log('📋 RELATÓRIO FINAL - RTP ULTRA ULTRA ULTRA AGRESSIVO (0.1%)');
    console.log('===========================================================\n');
...
ultraUltraUltraAggressiveRTPTest();
