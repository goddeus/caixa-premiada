...
async function ultraUltraUltraUltraAggressiveRTPTest() {
  console.log('💀 TESTE COM RTP ULTRA ULTRA ULTRA ULTRA AGRESSIVO (0.01%)');
  console.log('==========================================================\n');
  console.log('🎯 Objetivo: FORÇAR quebra total dos usuários');
  console.log('💰 RTP alvo: 0.01% (extremamente agressivo)\n');

  try {
    // Ajustar RTP para 0.01% (ultra ultra ultra ultra agressivo)
    ...
    for (let i = 1; i <= 3; i++) {
      const user = await prisma.user.create({
        data: {
          email: `teste.ultra.ultra.ultra.ultra.${timestamp}.${i}@teste.com`,
          nome: `Usuário Ultra Ultra Ultra Ultra ${i}`,
          saldo: 20.00,
          senha_hash: 'teste123',
    ...
    console.log('🎲 INICIANDO TESTE ULTRA ULTRA ULTRA ULTRA AGRESSIVO...\n');
    ...
    // Relatório final
    console.log('📋 RELATÓRIO FINAL - RTP ULTRA ULTRA ULTRA ULTRA AGRESSIVO (0.01%)');
    console.log('==================================================================\n');
...
ultraUltraUltraUltraAggressiveRTPTest();
