...
async function ultraAggressiveRTPTest() {
  console.log('💀 TESTE COM RTP ULTRA AGRESSIVO (10%)');
  console.log('========================================\n');
  console.log('🎯 Objetivo: FORÇAR quebra total dos usuários');
  console.log('💰 RTP alvo: 10% (extremamente agressivo)\n');
  ...
  try {
    ...
    for (let i = 1; i <= 3; i++) {
      const user = await prisma.user.create({
        data: {
          email: `teste.ultra.${timestamp}.${i}@teste.com`,
          nome: `Usuário Ultra ${i}`,
          saldo: 20.00,
          senha_hash: 'teste123',
    ...
    console.log('🎲 INICIANDO TESTE ULTRA AGRESSIVO...\n');
    ...
    // Relatório final
    console.log('📋 RELATÓRIO FINAL - RTP ULTRA AGRESSIVO (10%)');
    console.log('================================================\n');
