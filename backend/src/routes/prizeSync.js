 ...
 * @access Admin
 */
router.post('/sync-prizes-from-folders', prizeSyncController.syncPrizes);
 ...
 * @access Admin
 */
router.get('/sync-report/:timestamp', prizeSyncController.getSyncReport);
 ...
 * @access Admin
 */
router.get('/backups', prizeSyncController.listBackups);
 ...
 * @access Admin
 */
router.post('/restore-database', prizeSyncController.restoreDatabase);
 ...
 * @access Admin
 */
router.post('/restore-images', prizeSyncController.restoreImages);
 ...
 * @access Admin
 */
router.get('/audit-prizes', prizeSyncController.auditPrizes);
