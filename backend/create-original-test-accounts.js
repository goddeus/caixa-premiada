/**
 * Script para criar as contas originais de teste no banco de produção
 */
...
async function createOriginalTestAccounts() {
  console.log('🔧 Criando contas originais de teste no banco de produção...\n');

  try {
    // 1. CONTAS ADMIN ORIGINAIS
    console.log('👑 Criando contas admin originais...');
    ...
    // 2. CONTAS DEMO ORIGINAIS
    console.log('\n🎭 Criando contas demo originais...');
    ...
    console.log('\n' + '='.repeat(60));
    console.log('🎉 CONTAS ORIGINAIS CRIADAS COM SUCESSO!');
    console.log('='.repeat(60));
    
    console.log('\n📋 CREDENCIAIS DE ACESSO ORIGINAIS:');
    console.log('┌─────────────────────────────────────────────────────────┐');
    console.log('│                       ADMINS                            │');
    console.log('├─────────────────────────────────────────────────────────┤');
