...
async function runCompleteTest() {
  try {
    console.log('🚀 TESTE COMPLETO - TODAS AS CAIXAS (1-5 UNIDADES)\n');
    console.log('=' * 70);
      ...
      for (let qty = 1; qty <= 5; qty++) {
        ...
        for (let i = 0; i < qty; i++) {
          ...
          if (result.error) {
            ...
            premiosDetalhados.push(`Erro: ${result.error}`);
          } else {
            ...
            premiosDetalhados.push(`${result.premioNome} - ${premioText}`);
          }
