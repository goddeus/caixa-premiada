/**
 * Teste Real do Webhook de Depósito
 * Simula o que a VizzionPay enviaria para o sistema
 */
...
async function testWebhookReal() {
  console.log('🧪 TESTE REAL DO WEBHOOK DE DEPÓSITO');
  ...
  try {
    ...
    const testUser = {
      nome: 'Teste Webhook Real',
      email: `testewebhook${Date.now()}@slotbox.shop`,
      senha: '123456',
      cpf: '12345678901'
    };
    ...
    console.log(`   Valor esperado: R$ 100.00`);
    
    if (saldoCreditado === 100.00) {
    ...
    console.log(`✅ Saldo creditado: ${saldoCreditado === 100.00 ? 'SIM' : 'NÃO'}`);
